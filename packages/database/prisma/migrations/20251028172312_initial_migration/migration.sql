...
CREATE TABLE `otp` (
    ...
    UNIQUE INDEX `otp_email_otpCode_key`(`email`, `otpCode`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `payment` (
    ...
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `paymentMethod` ENUM('YEKPAY', 'ADMIN', 'NO_METHOD') NOT NULL,
...
CREATE TABLE `checkout` (
    ...
    UNIQUE INDEX `checkout_authority_key`(`authority`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `otp` ADD CONSTRAINT `otp_tutorId_fkey` FOREIGN KEY (`tutorId`) REFERENCES `tutor`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `checkout` ADD CONSTRAINT `checkout_courseId_fkey` FOREIGN KEY (`courseId`) REFERENCES `course`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

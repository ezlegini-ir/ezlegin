...
const rules = [
  ...
  "By registering on the site, the user consents to receive notifications and related messages from Ezlegin By email, SMS, or other communication methods.",
  ...
  "If the payment fails for any reason but the amount is deducted from the user's account, the user must contact Ezlegin support to resolve the issue. Ezlegin is not responsible for any delays or issues arising from payment gateways or banks.",
  "Users from North Korea, Iran, Syria, Cuba, and Sudan are not allowed to have any payment methods on the Ezlegin platform due to international sanctions and regulations.",
  "Users from United States of America are not allowed to have any payment methods on the Ezlegin unless they use a VPN to mask their location due to international sanctions and regulations. They should use a VPN to access the platform, like X-VPN, NordVPN, or any other reliable VPN service.",
  "User's address, city and postal code are required to start the purchase process on Ezlegin platform.",
